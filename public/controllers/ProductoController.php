...
class ProductoController extends Producto implements IApiUsable
{
    public function CargarUno($request, $response, $args)
    {
        ...
        ChangelogController::CargarUno("productos",$produc->nombre,$produc->puesto,"Cargar datos","Datos de un producto");
    ...
    public function TraerUno($request, $response, $args)
    {
        ...
        ChangelogController::CargarUno("productos",$producto->nombre,$produc,"Obtener datos","Datos de un producto");
    ...
    public function TraerSector($request, $response, $args)
    {
      ...
      ChangelogController::CargarUno("productos",$producto->nombre,$produc,"Obtener datos","Datos de un producto de un sector");
    ...
    public function TraerTodos($request, $response, $args)
    {
        ...
        ChangelogController::CargarUno("productos",0,0,"Obtener datos","Datos de todos los productos");
    ...
    public function ModificarUno($request, $response, $args)
    {
        ...
        ChangelogController::CargarUno("productos",0,$productoId,"Modificar datos","Modificacion de un producto");
    ...
    public function BorrarUno($request, $response, $args)
    {
        ...
        ChangelogController::CargarUno("productos",0,$productoId,"Borrar datos","Baja de un producto");
