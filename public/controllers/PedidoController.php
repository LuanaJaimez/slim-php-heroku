...
class PedidoController extends Pedido implements IApiUsable
{
    public function CargarUno($request, $response, $args)
    {
      ...
      ChangelogController::CargarUno("pedidos",$codigo,$nombre,"Cargar datos","Datos de un pedido");
    ...
    public function SacarFoto($request, $response, $args)
    {
      ...
      if($foto['size']>0)
      {
        ...
        ChangelogController::CargarUno("pedidos",$codigo,0,"Sacar Foto","Foto de un pedido");
      }
      else
      {
        $img = "La foto no existe";
    ...
    public function TraerUno($request, $response, $args)
    {
      ...
      ChangelogController::CargarUno("pedidos",$pd,0,"Obtener datos","Datos de un pedido");
    ...
    public function TraerPendiente($request, $response, $args)
    {
      ...
      ChangelogController::CargarUno("pedidos",0,0,"Pendientes","Obtener pedidos pendientes");
      return $response
        ->withHeader('Content-Type', 'application/json');
    }
    ...
    public function TraerListos($request, $response, $args)
    {
      ...
      ChangelogController::CargarUno("pedidos",0,0,"Listos","Obtenes pedidos listos");
      return $response
        ->withHeader('Content-Type', 'application/json');
    }
    ...
    public function VerDemora($request, $response, $args)
    {
      ...
      $payload = json_encode($pedido, $mesa);
    ...
    public function TraerPorPuesto($request, $response, $args)
    {
      ...
      ChangelogController::CargarUno("pedidos",0,0,"Traer por puesto","Datos de un pedido");
      return $response
        ->withHeader('Content-Type', 'application/json');
    }
    ...
    public function TraerTodos($request, $response, $args)
    {
      ...
      ChangelogController::CargarUno("pedidos",0,0,"Obtener datos","Datos de todos los pedidos");
    ...
    public function ModificarUno($request, $response, $args)
    {
      ...
      ChangelogController::CargarUno("pedidos",$pedidoId,0,"Modificar datos","Modificacion de un pedido");
    ...
    public function BorrarUno($request, $response, $args)
    {
      ...
      ChangelogController::CargarUno("pedidos",$pedidoId,0,"Borrar datos","Baja de un pedido");
    ...
    public function ActualizarEstado($request, $response, $args)
    {
      ...
      ChangelogController::CargarUno("pedidos",$codigo,$estado,"Actualizar datos","Actualizacion de un pedido");
      ...
      if(Pedido::obtenerPedido($codigo) != null)
      {
          if($puesto == "Cervecero")
          {
            if(Pedido::actualizarPedido($codigo, $estado, "Cervecero", $tiempo))
            {
              ...
              ChangelogController::CargarUno("pedidos",$codigo,$estado,"Actualizar datos", "($aviso)");
            }
            else
            {
